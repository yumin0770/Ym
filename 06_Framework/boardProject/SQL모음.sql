...
SELECT * FROM BOARD_IMG bi  ORDER BY BOARD_NO DESC;
...
FROM (
	...
	SELECT '웹접근경로' IMG_PATH , '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL ,
			1 IMG_ORDER , 2001 BOARD_NO
	FROM DUAL
	
	UNION ALL
	
	SELECT '웹접근경로' IMG_PATH , '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL ,
			2 IMG_ORDER , 2001 BOARD_NO
	FROM DUAL 
) A;
...
ORDER BY BOARD_NO DESC;
 ...
 INSERT INTO "COMMENT" 									--게시글, 회원번호
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1',DEFAULT,DEFAULT,2003, 16, NULL);

 INSERT INTO "COMMENT" 									--게시글, 회원번호
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2',DEFAULT,DEFAULT,2003, 16, NULL); 

INSERT INTO "COMMENT" 									--게시글, 회원번호 --자식댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-1',DEFAULT,DEFAULT,2003, 16, 1001); 

INSERT INTO "COMMENT" 									--게시글, 회원번호 --자식댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-2',DEFAULT,DEFAULT,2003, 16, 1001);

INSERT INTO "COMMENT" 									--게시글, 회원번호 --자식댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-3',DEFAULT,DEFAULT,2003, 16, 1001);

INSERT INTO "COMMENT" 									--게시글, 회원번호 --자식댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글2-1',DEFAULT,DEFAULT,2003, 16, 1002);

INSERT INTO "COMMENT" 									--게시글, 회원번호 --자식댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글2-2',DEFAULT,DEFAULT,2003, 16, 1002);

INSERT INTO "COMMENT" 									--게시글, 회원번호 --자식댓글
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 의 자식댓글2-1-1',DEFAULT,DEFAULT,2003, 16, 1006);
...
--계층형 쿼리(SATAR WITH, CONNECT BY, ORDER SIBLINGS BY)
