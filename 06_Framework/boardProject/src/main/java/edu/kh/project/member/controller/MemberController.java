...
//		session.invalidate(); // 세션 무효화 
	...
	public String signUp() {
		//WEB-INF/views/member/signUp.jsp   forward(요청 위임) //req.resp 안보이지만 안에 있다
		//-> ViewResolver가 prefix, suffix를 리턴값 앞,뒤에 붙임
	...
	public String signUp(Member inputMember, String[] memberAddress
		...
		//String addr = inputMember.getMemberAddress().replaceAll(",","^^^"); //모두 찾겠다 replaceAll
		//inputMember.setMemberAddress(addr);
		//-> 클라이언트가 , 직접 입력하면 문제 발생
		
		//만약 주소를 입력하지 않은 경우(,,)(빈칸) null로 변경!
