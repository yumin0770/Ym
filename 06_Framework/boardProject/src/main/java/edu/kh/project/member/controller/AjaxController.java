...
public String selectMemberTel(String nickname) {
	...
	//return 리다이렉트,포워드-> 새로운 화면 만들어짐(동기식)
...
//produces 속성은 한글 깨질 때 사용한다
	@GetMapping("/dupCheck/email")
	@ResponseBody //HttpMessgaeConvetor를 이용해 
			// JS에서 인식할 수 있는 형식으로 바꾸고(TEXT/JSON) 변환
			//+ 비동기 요청한 곳으로 돌아감
	public int checkEmail(String email) {
		return service.checkEmail(email); //String으로 반환
	...
	public int checkNickname(String nickname) {
		return service.checkNickname(nickname); //String으로 반환
