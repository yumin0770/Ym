...
public class BoardController2 {
	...
	public String boardInsert(
			...
			,Board board //ModelAttribute 생략  커멘드객체(필드에 파라미터 담겨있음!)
		...
		/*List<MultipartFile>
		 * -업로드된 이미지가 없어도 List에 요소 MulitipartFile 객체가 추가됨
		 * 단, 업로드된 이미지가 없는 MultipartFile 객체는 파일크기 (size)가
		 * 0 또는 파일명(getOrifinalFileName())이 
		 * 
		 * */
		...
		//게시글 삽입 성공 시
		//-> 방급 삽입한 게시글 상세 조회 페이지로 리다이렉트
		//-> board/{boarCode}/{boardNo}
