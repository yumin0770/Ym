...
public class BoardView {
	...
	public void selectBoard() {
		...
		try {
            ...
            if(Session.loginMember.getMemberNo() == board.getMemberNo()) {
            	...
            	System.out.println("0) 이전 게시판 메뉴로 돌아가기 ");
            	
            	System.out.print("선택 >>");
            	
            	input = sc.nextInt(); //재활용
            	sc.nextLine();
	...
	public void insertBoard() {
		...
		try {
			//게시글 삽입 서비스 호출
			int result = boardService.insertBoad(boardTitle,sb.toString(),Session.
