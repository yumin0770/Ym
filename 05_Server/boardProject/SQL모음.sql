...
BEGIN
   FOR I IN 1..2000 LOOP
      ...
      VALUES( SEQ_BOARD_NO.NEXTVAL,
              ...
              DEFAULT, DEFAULT, DEFAULT, DEFAULT, 16, 
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'cat1.jpg', 0, 1992);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'cat2.jpg', 0, 1990);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'cat3.jpg', 0, 1989);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'cat4.jpg', 0, 1981);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'cat5.jpg', 0, 1962);
...
--MYBATIS 없을 때
--1~10행 조회
--ROWNUM 은 WHERE절에 사용될 때 1행이 조건에 포함이 되어야 한다.
SELECT * FROM(
...
SELECT BOARD_NO,BOARD_TITLE,BOARD_CONTENT,BOARD_CODE, 
	...
	(SELECT COUNT(*) 
	FROM "BOARD_LIKE" L
	WHERE L.BOARD_NO = 1992) LIKE_COUNT
FROM "BOARD"
JOIN "MEMBER" USING(MEMBER_NO)
WHERE BOARD_DEL_FL = 'N'
AND BOARD_CODE = 1
...
INSERT INTO "BOARD_LIKE" VALUES(1992,16);
COMMIT;
...
--회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG  = '/resources/images/member/RP.jpg'
WHERE MEMBER_NO = 16;
...
WHERE BOARD_NO  = 1992 --게시글 번호
AND MEMBER_NO = 16;--로그인 회원 번호
