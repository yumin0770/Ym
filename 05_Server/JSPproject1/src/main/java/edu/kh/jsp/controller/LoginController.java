...
@WebServlet("/login") //현재 클래스를 Servlet 등록 + /login 요청 처리
public class LoginController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//POST방식의 문제점: 한글이 깨진다(인코딩 불일치 문제)
		...
		//forward를 하면 주소창 요청 주소로 바뀌고
		//그 요청에 맞는 화면으로 변함
		//(요청에 맞는 응답을 했기 때문에)
		
		
		//-> Servlet이 가지고 있던 req,resp객체를
		//JSP에게 전달하여 요청을 실제 위임
