package edu.kr.polymorphism.ex1.service;
import java.util.Scanner;

import edu.kr.polymorphism.ex1.dto.Car;
import edu.kr.polymorphism.ex1.dto.LightCar;
import edu.kr.polymorphism.ex1.dto.Truck;
...
public class CarService {
	...
	public void ex1() {
		...
		//c2.setWeight(2.5); //c2로 접근 불가능하여 에러 (자식꺼라서 안 됨)
		
		//부모타입 참조 변수로 참조 시 부모 부분만 참조 가능
...
//		//LightCar로 c1을 강제 형변환
	...
	public void ex3() {
		...
		for( Car c : carList ) {
			...
			//해결 방법: instaceof를 통해 참조하는 객체의 자료형을 판단하여
			//적절한 형식으로 다운 캐스팅 진행
		...
		public void printCar(Car c) {
			...
			System.out.println( type + "에 대한 정보입니다ㅣ.");
			System.out.println(c.toString());
			//String edu.kr.polymorphism.ex1.dto.Car.toString
