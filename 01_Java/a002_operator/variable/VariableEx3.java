...
//	num2 = 999; 
	...
	/*상수 명령 규칙 및 활용법*/
	// - 명명규칙: 모두 대문자로 표기, 단어 구분 시 _ 사용
	final int COMSTANT_NUMBER = 100;
	...
	// 1.대소문자가 구분이되며 길이 제한이 X.
	int apple;
	//Duplicate local variable apple
	int applE;
	
	//길이 제한 X
	int freeTradeAgreement; //길어도 문제 없음
	int showMeTheMoney;
	...
	//double char;
	//double final;
	//Syntax error on token "int", invalid VariableDeclarator
