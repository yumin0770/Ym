...
public class ListService {
	 ...
	 * 
	 * List 인터페이스를 대표적인 구현한 클래스
	 * ->ArrayList, Vector(구버전), LinkedList 
	 * */
...
//		ArrayList list = new ArrayList(); ->기본 생성자 -> 10칸짜기 생성
		
		ArrayList list = new ArrayList(3); // 매개변수 생성자 -> 3칸짜기 생성
		//메모리 아까기 위해
		
		//-> 예상되는 데이터 수에 따라 생성자를 골라서 사용
		// -> 생성되는 List 객체에 따라 속도, 메모리 효율이 달라짐
...
//		list.add(10, "삽입"); //오류발생
	...
	// int size() : 리스트 크기 X,리스트에 저장된 요소의개수 0
