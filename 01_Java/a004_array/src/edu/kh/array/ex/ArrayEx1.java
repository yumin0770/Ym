...
public class ArrayEx1 {
	...
	//배열 기본 사용법2: 초기화
	public void ex2() {
		//배열 : 같은 자료형의 변수를 하나의 묶음으로 다루는ㄴ 것
		...
		// ->index 번호가 추가; 기본값(0)으로 초기화
		// +시작주소 부여 ex) 0x5123
		
		//3) Heap영역에 생성된 배별의 시작 주소(0x5123)를
		// stack 영역 참조 변수 numbers에 대입한다.
		
		//1.장밀 nmbers의 죽소가 저장 되었을까?
	...
	//컴파일러가 0으로 초기화 하였음을 확인
		...
		// breakpoint : debug 모드로 실행 시 해당 줄의 코드가 수행되기 전 멈춤
		System.out.println("==================================================");
	...
	public void ex5() {
		...
		//			ArryaIndexOutOfBoundsException이 발생함.
