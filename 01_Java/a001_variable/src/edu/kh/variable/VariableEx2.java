...
public class VariableEx2 {
	 ...
	 * 			int     (4byte, 정수 기본형)
	 * 			long    (8byte)
	 * 실수형 : float   (4byte) 최대 8자리
	 *  		double  (8byte, 실수 기본형) 최대 16자리
...
//  자료형 변수명
	...
	double number2;
	//실수형 데이터를 저장할 공간
	//8byte를 메모리(RAM)에 할당하고
	//그 공간을 number2이라고 부르겠다.
	
	char ch;
	//문자형 데이터를 저장할 공간
	//2byte를 메모리(RAM)에 할당하고
	//그 공간을 ch이라고 부르겠다.
	...
	booleanData = true; 
//	number1 = 123456789.123444;
	//Type mismatch : cannot conver from double to int
	...
	//ch = 'AA' //char자료형은 ''안에 문자 하나만 작성 가능
	ch = 'A';
	...
	//** 자료형별로 리터럴 표기하는 방법이 별도로 존재**//

	// int : 10, -50, 0 (기본 정수 표기법)
	
	// long : 2147483648L, 0L, -10L (l , L) 보통 대문자 L로 씀
    //long i = 2147483648L;
	
	// double : 3,14, -123.456, 0.0
	// (기본 실수 표기법, 모든 실수형태로 작성)
