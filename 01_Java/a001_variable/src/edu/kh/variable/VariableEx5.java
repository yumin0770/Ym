...
public class VariableEx5 {
	 ...
	 *  (같은 자료형끼리 연산, 결과도 같은 자료형) int는 int끼리
	 *  
	 *  [자동형변환]
 ...
 // = : 대입 연산자 (대입도 연상이다)
	...
	int test1 = 290;
	byte test2 = (byte)test1; //Type mistach : cannot cotver from int to byte
		// 변환 시키고자 하는 자료형을 명시해 강제 변환
	
	System.out.println("test1 " + test1);
	System.out.println("test2 " + test2);

	
	//crtl + alt + 방향키 위/아래 : 라인 복사
...
//	long iNum3 = (long)iNum1 + iNum2; //해결방법
