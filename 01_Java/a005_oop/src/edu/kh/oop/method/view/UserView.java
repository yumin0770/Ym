...
public class UserView {
	...
	// -< 어디서든지 클래스명.필드명 으로 접근 가능  //static 어디서든지 접근 가능한 공간
	public static User loginUser = null;  //null인 경우 로그인x .값이 있는 경우 로그인O

	//기본 생성자
		public UserView() {
			//기본 생성자로 객체 생성 시
			//UserView.loginUser에 객체 주소 대입하기
			signUpUser = new User("user","1234","테스트",'F');
		}
	...
	if(signUpUser !=null){ //sighUpUser가 참조를 하고 있는 경우
							// 주소가 저장된 경우
