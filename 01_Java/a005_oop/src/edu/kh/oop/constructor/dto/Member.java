...
public class Member {//캡슐화
	...
	{ //->인스터스 초기화블럭의 모양
		...
		memberName = "고길동";
		memberAge = 40;
		//programName = "회원관리 프로그램" > 여기에 있으면 여러번 수행됨
		
	}
	//클래스 초기화 블럭
	//-프로글램 실행 시 static 변수를 초기화 하는 용도의 블럭
	//(프로그램 실행 시 1회만 수행됨) >효율성을 높여줌
	static {
...
// 		
	...
	public Member(String memberId, String memberPw) {} //성립 (개수)가 달라서
	
	public Member(String memberId, int memberAge) {} //성립 (타입)이 다름
	
	public Member(int memberAge,String memberId) {} //성립 (순서)

	//public Member(int memberAge,String memberName) {} //오류 성립X (순서) ->위에랑 자료형 똑같음
