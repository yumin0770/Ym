...
document.querySelector("#btn1").addEventListener("click",()=>{
    ...
    const arr2 = str2.split(",", 5); //다섯개까지 나옴 
...
document.querySelector("#btn2").addEventListener("click",function(e){
    ...
    //JavaScript : Infinity  (값이 무한으로 나옴)
    ...
    //isNaN(연산/값) : 연산/값의 결과가 NaN이면 true를 반환
    if(isNaN("abc" * 100) ){
...
/*     const num = "1.234"; */
    ...
    console.log(parseFloat(num));//1.234
 
    console.log(Number(num)); //1.234
