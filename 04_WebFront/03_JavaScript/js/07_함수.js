...
document.querySelector("#button4").addEventListener("click", () => {
    ...
    //익명 함수
    prinkConsole( function(num){ return num*10; })


});
    //화살표 함수
/*     prinkConsole((num)=>{return num * 100;}); */
 //매개변수 1개 -> ()생략
 /*    prinkConsole(num=>{return num * 100;});
 */
    //함수 정의 부분에 return만 작성 -> {},return 생략
    prinkConsole(num => num * 100); 

    //5번.함수 정의 부분에 return 구문만 있지만 자료형이 object인 경우
...
//클릭된 요소의 폰트크기를 25px로 증가(익명, e 사용X,this 사용 가능 O)
...
//클릭된 요소의 테두리를 3px로 실선 핑크로 변경(화살표, e 사용X, this사용)
button6.addEventListener("click", ()=>{
    console.log(this);
    //화살표 함수에서 this를 작성하면 이벤트가 발생한 요소가 아닌 창 자체를 나타내는 
    //window 객체가 반환된다.
